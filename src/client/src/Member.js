        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="container-fluid">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Input member interests" id="floatingTextarea2" style={{height: "100px"}} onChange={(e) => update(e.target.value, "interests")} value={memberValues.interests}></textarea>
                        <label for="floatingTextarea2">Member Interests</label>
                    </div>

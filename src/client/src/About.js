        ...
        <div>
            ...
            <div class="d-flex p-2 justify-content-evenly">
                <div class="card" style={{width: "18rem "}}>
                    ...
                    <div class="card-body">
                        <h5 class="mb-2"><strong>Gilberto Arellano</strong></h5>
                        <p class="text-muted">Gilberto description</p>
                    </div>
                ...
                <div class="card" style={{width: "18rem "}}>
                    ...
                    <div class="card-body">
                        <h5 class="mb-2"><strong>Luis Rivas</strong></h5>
                        <p class="text-muted">Luis description</p>
                    </div>
                    <div class="card-body d-flex justify-content-evenly">
                ...
                <div class="card" style={{width: "18rem "}}>
                    ...
                    <div class="card-body">
                        <h5 class="mb-2"><strong>Minna Yu</strong></h5>
                        <p class="text-muted">Minna is a Software Engineering major at Chapman University. She is particularly interested in web design and drinking honey lavender lattes.</p>
                    </div>
                    <div class="card-body d-flex justify-content-evenly">
